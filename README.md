...
| `foo_autoplay` | [sourceforge: sourceforge.net/projects/fooautoplay/files/fooautoplay](https://sourceforge.net/projects/fooautoplay/files/fooautoplay/) |
...
| `foo_dsp_neutralizer` | [sourceforge: sourceforge.net/projects/dvdadecoder/files/foo_dsp_neutralizer](https://sourceforge.net/projects/dvdadecoder/files/foo_dsp_neutralizer/) |
| `foo_dsp_openal` | [sourceforge: sourceforge.net/projects/foobar-openal/files/foo_dsp_openal](https://sourceforge.net/projects/foobar-openal/files/foo_dsp_openal/) |
...
| `foo_httpserver_ctrl` | [sourceforge: sourceforge.net/projects/foohttpserver/files/foohttpserver](https://sourceforge.net/projects/foohttpserver/files/foohttpserver/) |
...
| `foo_input_apt-x100` | [sourceforge: sourceforge.net/projects/dvdadecoder/files/foo_input_apt-x100](https://sourceforge.net/projects/dvdadecoder/files/foo_input_apt-x100/) |
| `foo_input_asciimusiccom` | [mk-822/foo_input_asciimusiccom (github)](https://github.com/mk-822/foo_input_asciimusiccom) |
| `foo_input_dtshd` | [sourceforge: sourceforge.net/projects/dvdadecoder/files/foo_input_dtshd](https://sourceforge.net/projects/dvdadecoder/files/foo_input_dtshd/) |
| `foo_input_dvda` | [sourceforge: sourceforge.net/projects/dvdadecoder/files/foo_input_dvda](https://sourceforge.net/projects/dvdadecoder/files/foo_input_dvda/) |
...
| `foo_input_udsd` | [sourceforge: sourceforge.net/projects/sacddecoder/files/macOS%20%2BWindows/foo_input_udsd](https://sourceforge.net/projects/sacddecoder/files/macOS%20%2BWindows/foo_input_udsd/) |
...
| `foo_lirc` | [sourceforge: sourceforge.net/projects/foolirc/files/foo_lirc](https://sourceforge.net/projects/foolirc/files/foo_lirc/) |
...
| `foo_out_asio2` | [sourceforge: sourceforge.net/projects/foobar2000-wasap2-output/files](https://sourceforge.net/projects/foobar2000-wasap2-output/files/) |
| `foo_out_pulse` | [sammoth/foo_out_pulse (github)](https://github.com/sammoth/foo_out_pulse) |
| `foo_out_wasap2-asio2` | [sourceforge: sourceforge.net/projects/foobar2000-wasap2-output/files](https://sourceforge.net/projects/foobar2000-wasap2-output/files/) |
...
| `foo_popupplus` | [sourceforge: sourceforge.net/projects/foopopupplus/files/foopopupplus](https://sourceforge.net/projects/foopopupplus/files/foopopupplus/) |
